...
{
    using StateBase = StateMachine<PlayerControllerSample>.StateBase;

    public class PlayerControllerSample : MonoBehaviour, Damagable
    {
        ...
        private StateMachine<PlayerControllerSample> stateMachine; //ステート遷移制御
        ...
        void Start() 
        {
            ...
            stateMachine = new StateMachine<PlayerControllerSample>(this);
        ...
        void Update() 
        {
            ...
            playerStatus.m_stumina = Mathf.MoveTowards(playerStatus.GetStumina, 100, Time.deltaTime * 2);
        ...
        private class StateStun : StateBase
        {
            ...
            private CancellationTokenSource cts;
            private PlayerControllerSample playerControllerSample;
            ...
            public override void OnStart()
            {
                ...
                // アニメーションステートを設定
                Owner.animationState.SetState("Stun", true);
