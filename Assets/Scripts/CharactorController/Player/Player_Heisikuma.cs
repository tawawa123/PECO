...
{
    using StateBase = StateMachine<Player_Heisikuma>.StateBase;

    public class Player_Heisikuma : MonoBehaviour, Damagable
    {
        ...
        private StateMachine<Player_Heisikuma> stateMachine; //ステート遷移制御
        ...
        void Start() 
        {
            ...
            stateMachine = new StateMachine<Player_Heisikuma>(this);
